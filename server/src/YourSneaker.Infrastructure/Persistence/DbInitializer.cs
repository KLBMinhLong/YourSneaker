...
public static class DbInitializer
{
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        var categoriesMap = context.Categories.ToDictionary(c => c.Slug, c => c.Id);
        var jordanId = categoriesMap.GetValueOrDefault("air-jordan");
        var yeezyId = categoriesMap.GetValueOrDefault("yeezy");
        var nikeDunkId = categoriesMap.GetValueOrDefault("nike-dunk");
        var newBalanceId = categoriesMap.GetValueOrDefault("new-balance");

        // Seed 16 Rich Products if product count is less than 10
        if (context.Products.Count() < 10)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product
                {
                    ...
                    Price = 26500000 / 10, // 2.650.000 VND
